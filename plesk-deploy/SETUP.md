...
Non mettere deploy.php dentro `webapp/` — deve stare nella root.
...
2. Fai un push su GitHub (anche solo modifica un carattere in index.html)
   ...
   → Controlla `https://poilove.com/webapp/` — deve mostrare la demo aggiornata
...
deploy.php: scarica i 4 file da GitHub API
    ↓
Salva in webapp/ e sal/ su poilove.com
    ↓
Due URL aggiornati in < 10 secondi:
  · https://poilove.com/webapp/
