...
(function () {
  ...
  function openBuilder(lp) {
    ...
    EvolabBuilder.openModal({
      ...
      doc: lp.design || null,
      brand: { accent: '#D42B2B', footer: 'Inxhinieruar nga Alessandro Castagna · 321.AL / EVOLAB • Tiranë\nIngegnerizzazione di Alessandro Castagna · 321.AL / EVOLAB • Tirana', name: 'POI•LOVE', linkBase: 'https://poilove.com/', title: lp.title || '' },
      ...
      onSave: function (doc, html, text, vals) {
        ...
        html = (window.EvolabBuilder).renderPage(doc, { accent: '#D42B2B', footer: 'Inxhinieruar nga Alessandro Castagna · 321.AL / EVOLAB • Tiranë\nIngegnerizzazione di Alessandro Castagna · 321.AL / EVOLAB • Tirana', name: 'POI•LOVE', linkBase: 'https://poilove.com/', title: (vals.title || slug) });
