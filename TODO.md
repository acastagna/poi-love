...
- [ ] **Cartografia: decidere il vestito definitivo** (23/08): Carto/Voyager ha messo la chiave obbligatoria e la mappa live si e' riempita di mattonelle-timbro; sistemato IN GIORNATA passando a OSM standard (stradale) + livello nomi Esri (satellite e lente), senza chiave. L'estetica Voyager (pallida, calda) pero' era la nostra: valutare con calma se prendere la chiave Carto (conto suo), passare a tegole vettoriali self-hosted, o tenere OSM. Vale anche per l'app nativa (il piano citava Voyager: aggiornarlo).
